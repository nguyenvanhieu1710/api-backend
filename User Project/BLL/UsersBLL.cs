...
namespace BLL
{
    public class UsersBLL : IUsersBLL
    {
        ...
        public UsersBLL(IUsersDAL IUsersDAL, IAccountBLL accountBLL, IConfiguration configuration)
        {
        ...
        {
            return _IUsersDAL.Register(request);
        }
        ...
        public (UsersModel, AccountModel) Authenticate(string accountName, string password)
        {
            ...
            UsersModel info = GetDataById(account.AccountId) as UsersModel;
